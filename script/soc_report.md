...
- `_context_for_anomalies()` — собирает контекст для каждой аномалии, формирует "описание".
...
- Контекстная таблица `anomaly_context_<scope>_<date>.csv` в `anomaly/` с колонками `описание` и `программы`.
